...
- REQ-760 (AC-6): The .NET SDK shall be pinned by `presentation/global.json` (10.0.100, roll forward within 10.0); the .NET test project shall contain an environment test that loads DuckDB's native library and reads a Parquet file.
