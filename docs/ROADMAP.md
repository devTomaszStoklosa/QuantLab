...
| q5-equities-cross-section | Ready for dev | Ready for dev | Ready for dev | X1–X4 gotowe (point-in-time uniwersum, corporate actions, delisting i survivorship bias, polityka rebalansu) |
