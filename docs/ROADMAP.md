...
| q4-pairs-trading-stat-arb | Ready for dev | Ready for dev | Ready for dev | P1–P4 gotowe; P5 (zamrożenie `pairs_v1`) czeka na odpowiedzi na pytania pre-rejestracji |
