...
| q5-equities-cross-section | Ready for dev | Ready for dev | Ready for dev | X1–X5 gotowe (point-in-time uniwersum, corporate actions, delisting i survivorship bias, polityka rebalansu, momentum przekrojowe); X7–X8 czekają na decyzje (01-story) |
