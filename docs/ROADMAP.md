...
| q8-parameter-selection-cpcv | Ready for dev | Ready for dev | Ready for dev | P1–P5 gotowe (dokumentacja, CPCV, strategia z doborem, konfiguracje w DSR, PBO siatki i raport, bramka CPCV w kryterium); P6 (magazyn i aplikacja) w toku; P7 czeka na pytania 1–6 (01-story) |
